...
class Application(Gtk.Application):
    def __init__(self):
        super().__init__(application_id='pm.mirko.Twitz',
    ...
    def do_activate(self):
        '''Load custom CSS'''
        data_bytes = Gio.resources_lookup_data("/pm/mirko/Twitz/style.css", 0)
        ...
        if not win:
            win = TwitzWindow(application=self)
    ...
    def help(action, param):
        '''Open Help URL [F1]'''
        webbrowser.open_new_tab("https://github.com/mirkobrombin/Twitz")
